...
const trips = [
  {
    ...
    includes: ["Up to 4 anglers", "All tackle & live bait", "License covered"],
  ...
  },
  {
    ...
    includes: ["Up to 4 anglers", "All tackle & live bait", "Cooler with water & ice"],
  ...
  },
  {
    ...
    includes: ["Up to 4 anglers", "All tackle & live bait", "Fight chair available"],
